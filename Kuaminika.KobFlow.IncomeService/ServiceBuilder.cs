...
namespace Kuaminika.KobFlow.IncomeService
{
    public class ServiceBuilder
    {
        ...
        private ServiceBuilder(IKonfig config)
        {
            ...
            this.LogTool.ServiceName = "IncomeService";
        ...
        public IIncomeService Build()
        {
            ...
            args.CacheTool = new CacheHolder<IncomeModel>(CacheRoot.MemoryCache, KConstants.CacheExpirationInSeconds);
           args.IdentityMap = new KIdentityMap<IncomeModel>();
